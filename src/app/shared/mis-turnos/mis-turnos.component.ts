...
export class MisTurnosComponent implements OnInit {
  ...
  finalizarConfirmarHandler(reviewEHistoriaVuelo: {review:string, historiaVuelo:any}) {
    const review = reviewEHistoriaVuelo.review;
    const hc = reviewEHistoriaVuelo.historiaVuelo;
